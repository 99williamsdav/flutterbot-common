...
namespace BetfairApi
{
    ...
    {
        IList<Dictionary<string, object>> listRaceDetails(ISet<string> eventIds);
         ...
         * */
        IList<MarketCatalogue> listMarketCatalogue(MarketFilter marketFilter, ISet<MarketProjection> marketProjections, MarketSort marketSort, int maxResult = 1, string locale = null);

        /**
         * calls api-ng to get a list of market types
         * */
